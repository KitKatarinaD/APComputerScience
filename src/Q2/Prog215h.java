...
//        try {
//            Scanner input = new Scanner(new File("data/Q2.Prog215h.txt"));
//            ArrayList<Q2.prog215hHelper> contestant1 = new ArrayList<Q2.prog215hHelper>();
//            Q2.prog215hHelper help = new Q2.prog215hHelper( one, double two, double three, double four, double five, double six, double seven, double eight)
//            for (int i = 0; i < 8; i++) {
//                contestant1.set(i, Q2.prog215hHelper);
//                Q2.prog215hHelper.calc();
//            }
//
//            for (Q2.prog215hHelper score : contestant1) {
//                tot1 += score;
//            }
//            double avg1 = tot1/8;
//
